    ...
    <div class="modal-content">
     ...
     <form class="form-horizontal">
      <div class="modal-body">
        ...
        <div class="form-group">
          <div class="col-md-12">
            <label>Panjang / Satuan</label>
          </div>
          <div class="col-md-12">
            <input name="jumlah_produk_edit_panjang" id="jumlah_produk_edit_panjang" class="form-control" type="number" value="1" required>
          </div>
          <div class="col-md-12">
            <label>Lebar / Satuan</label>
          </div>
          <div class="col-md-12">
            <input name="jumlah_produk_edit_lebar" id="jumlah_produk_edit_lebar" class="form-control" type="number" value="1" required>
          </div>
          <div class="col-md-12">
          ...
          <div class="col-md-12">
            <label>Total Ukuran X Jumlah</label>
          </div>
          <div class="col-md-12">
            <input name="jumlah_produk_edit_total" id="jumlah_produk_edit_total" class="form-control" type="number" disabled>
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12">
          ...
          $.ajax({
            ...
            success : function(data){
              ...
              for(i=0; i<data.length; i++){
                ...
                var harga_satuan = harga_akhir* data[i].sub_jumlah1*data[i].sub_jumlah2;
                if (data[i].harga_minimum>=harga_satuan) {
                  var harga_satuan_akhir = data[i].harga_minimum;
                }else{
                  var harga_satuan_akhir = harga_satuan;
                }
                 totalpenjualan+=harga_satuan_akhir*data[i].jumlah;
                html += '<tr>'+
                '<td>'+ no++ +'</td>'+
      ...
      $.ajax({
        ...
        success : function(bayar){
          ...
          for(i=0; i<bayar.length; i++){
            ...
            total_jumlah = bayar[i].jumlah*bayar[i].sub_jumlah1*bayar[i].sub_jumlah2;

            

            var harga_satuan = harga_akhir_pembayaran* bayar[i].sub_jumlah1*bayar[i].sub_jumlah2;
            if (bayar[i].harga_minimum>=harga_satuan) {
              var harga_satuan_akhir = bayar[i].harga_minimum;
            }else{
              var harga_satuan_akhir = harga_satuan;
            }
            bayartotalpenjualan+=harga_satuan_akhir*bayar[i].jumlah;
            // subtotal+=bayar[i].harga_jual*total_jumlah;
            subtotal+=harga_satuan_akhir*bayar[i].jumlah;
            bayar_discount+=total_jumlah*(bayar[i].harga_jual*bayar[i].disc_1/100)-((bayar[i].harga_jual-(bayar[i].harga_jual*bayar[i].disc_1/100))*bayar[i].disc_2/100)-((bayar[i].harga_jual-(bayar[i].harga_jual*bayar[i].disc_1/100)-((bayar[i].harga_jual-(bayar[i].harga_jual*bayar[i].disc_1/100))*bayar[i].disc_2/100))*bayar[i].disc_3/100);
            potongan+=bayar[i].potongan*total_jumlah;
          }
          sub_bayar = subtotal+potongan+bayar_discount;

          $('#bayar_sub_total').val(sub_bayar);
...
$('#btn_simpan_bayar').on('click',function(){
  ...
  var total_beli = $('#bayar_total').val();
  ...
  $.ajax({
    ...
    dataType : "JSON",
    data : {total_beli:total_beli, sub_total:sub_total , discount:discount, potongan:potongan, terbilang:terbilang,uang_bayar:uang_bayar,kembalian:kembalian,kode_faktur:kode_faktur},
    success: function(data){
      ...
      $.ajax({
        ...
        success: function(data){
          ...
          for(i=0; i<data.length; i++){
            ...
            var harga = harga_satuan_akhir*data[i].jumlah;
            total_belanja += harga;
            ...
            total_barang_harga+=data[i].jumlah*harga_satuan_akhir;
    ...
    $('#btn_tambah_faktur').on('click',function(){
      ...
      return false;
        ...
        $('#show_data').on('click','.item_edit',function(){
          ...
          $.ajax({
            ...
            success: function(data){
              ...
              $('[name="jumlah_produk_edit_panjang"]').val(panjang);
              $('[name="jumlah_produk_edit_lebar"]').val(lebar);
              

              
              $('#jumlah_produk_edit_panjang,#jumlah_produk_edit_lebar,#jumlah_produk_edit, .item_edit').on('keydown click change keyup paste blur load keyup',function(){
                var jumlah_produk_edit_panjang  = $('#jumlah_produk_edit_panjang').val();
                var jumlah_produk_edit_lebar  = $('#jumlah_produk_edit_lebar').val();
                var jumlah_produk_edit  = $('#jumlah_produk_edit').val();
                var jumlah_produk_edit_total = jumlah_produk_edit_panjang*jumlah_produk_edit_lebar*jumlah_produk_edit;
                // alert(jumlah_produk_edit_total);
                $('[name="jumlah_produk_edit_total"]').val(jumlah_produk_edit_total);
              });
        ...
        $('#btn_simpan_edit').on('click',function(){
          ...
          var jumlah_produk_edit = $('#jumlah_produk_edit').val();
          var panjang = $('#jumlah_produk_edit_panjang').val();
          var lebar = $('#jumlah_produk_edit_lebar').val();
          ...
          $.ajax({
            ...
            dataType : "JSON",
            data : {panjang:panjang,lebar:lebar,potongan:potongan,
