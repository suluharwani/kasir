...
<!--             <li><a href="<?=base_url('admin')?>"><i class="fa fa-circle-o"></i> Semua Penjualan</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?=base_url('admin/product')?>"><i class="fa fa-circle-o"></i> Produk</a></li>
            <li><a href="<?=base_url('admin/pembelian')?>"><i class="fa fa-circle-o"></i> Pembelian</a></li>
            <li><a href="<?=base_url('admin/supplier')?>"><i class="fa fa-circle-o"></i> Supplier</a></li>
          </ul>
        </li>
        <li>
