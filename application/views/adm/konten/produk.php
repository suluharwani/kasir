...
<div class="form-group">
 <div class="col-md-12">
  <label class="control-label" >Harga Minimum</label>
</div>
<div class="col-md-12">
  <input type="number" name="harga_minimum_edit" id="harga_minimum_edit" class="form-control"  required="true" >    
</div>
</div>
<div class="form-group">
 <div class="col-md-12">
...
<div class="col-md-12">
  <input name="harga_minimum_det" id="harga_minimum_det" class="form-control" type="text"   disabled>
  <input name="terbilang_harga_minimum_det" id="terbilang_harga_minimum_det" class="form-control" type="text"   disabled>
...
<script type="text/javascript">
  $(document).ready(function(){
          ...
          $.ajax({
            ...
            success : function(data){
              ...
              for(i=0; i<data.length; i++){
                ...
                '<a href="javascript:void(0);" class="btn btn-warning btn-sm item_detail"  minimum="'+data[i].harga_minimum+'" jual="'+data[i].harga_jual+'" product_code_det="'+data[i].kode_produk+'" hpp_det="'+hpp+'" data-price="'+data[i].product_price+'">Detail</a>'+' '+
                '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" kode_produk_edit="'+data[i].kode_produk+'" nama_produk_edit="'+data[i].nama_produk+'" harga_edit="'+data[i].harga+'" id_barang="'+data[i].id_produk+'" harga_jual="'+data[i].harga_jual+'" harga_minimum="'+data[i].harga_minimum+'" disc_1_edit="'+data[i].disc_1+'" disc_2_edit="'+data[i].disc_2+'" disc_3_edit="'+data[i].disc_3+'" kategori_edit="'+data[i].id_cat+'" sub_kategori_edit="'+data[i].id_sub_cat+'" barcode_edit="'+data[i].barcode+'" stock_produk_edit="'+data[i].jumlah+'" supplier_edit="'+data[i].id_supplier+'">Edit</a>'+' '+
          ...
          $.ajax({
            ...
            success: function(data){
             ...
             $.each(data, function(key, value) {
              ...
              var terbilang_min = sayit(minimum);
              ...
              $('[name="harga_minimum_det"]').val(value.harga_minimum);
              $('[name="nama_admin_det"]').val(value.nama_admin_produk);
              $('[name="terbilang_harga_minimum_det"]').val(terbilang_min);
        ...
        $('#show_data').on('click','.item_edit',function(){
          ...
          var harga_minimum        = $(this).attr('harga_minimum');
          ...
          if (id_sub_kategori) {
           $.ajax({
            ...
            success:function(data) {
              ...
              $('#harga_minimum_edit').val(harga_minimum);
        ...
        $('#btn_simpan_edit').on('click',function(){
          ...
          var harga_minimum        = $('#harga_minimum_edit').val();
          var stock_produk_edit        = $('#stock_produk_edit').val();
          $.ajax({
            type : "POST",
            url  : "<?php echo site_url('admin/update_barang')?>",
            dataType : "JSON",
            data : {kode_produk:kode_produk, id_barang:id_barang , stock_produk_edit:stock_produk_edit, nama_produk:nama_produk, disc_1:disc_1, disc_2:disc_2, disc_3:disc_3, harga:harga, harga_jual:harga_jual,harga_minimum:harga_minimum, barcode:barcode},
            success: function(data){
