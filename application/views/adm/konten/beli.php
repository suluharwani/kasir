...
<script type="text/javascript">
  $(document).ready(function(){
          ...
          $.ajax({
            ...
            success : function(data){
              ...
              for(i=0; i<data.length; i++){
                ...
                '<a href="javascript:void(0);" class="btn btn-info btn-sm item_edit" product_code="'+data[i].kode_produk+'" det_nama_produk="'+data[i].nama_produk+'" jumlah_produk_edit="'+data[i].jumlah+'" harga_edit="'+data[i].harga+'" disc_1_edit="'+data[i].disc_1+'" disc_2_edit="'+data[i].disc_2+'" disc_3_edit="'+data[i].disc_3+'" hpp_edit="'+hpp+'" harga_jual_edit="'+data[i].harga_jual+'" harga_minimum_edit="'+data[i].harga_minimum+'" nota="'+data[i].id_pembelian+'" barcode_edit="'+data[i].barcode+'">Edit</a>'+' '+
        ...
        $('#show_data').on('click','.item_edit',function(){
          ...
          var harga_minimum_edit  = $(this).attr('harga_minimum_edit');
          ...
          $.ajax({
            ...
            success: function(data){
              ...
              $('[name="harga_minimum_edit"]').val(harga_minimum_edit);
        ...
        $('#btn_simpan_edit').on('click',function(){
          ...
          var harga_minimum_edit = $('#harga_minimum_edit').val();
          ...
          $.ajax({
            ...
            data : {kode_faktur:kode_faktur,
              ...
              harga_minimum_edit:harga_minimum_edit,
